...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/06 16:28:44 by yujelee           #+#    #+#             */
/*   Updated: 2023/03/06 16:28:45 by yujelee          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
t_vec	point_light_get(t_meta meta, t_ray ray, t_light *light, int *shadow)
{
	t_vec	diffuse;
	t_vec	light_dir;
	t_ray	light_ray;
